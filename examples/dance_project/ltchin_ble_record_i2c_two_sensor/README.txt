Open main.html for the javascript version or ltchin_ble_twosensor_CU.py for the Python version.
...
* ltchin_ble_twosensor_CU.py -- a Python version to connect to the ESP32 instead. Relies on bleak (https://github.com/hbldh/bleak) which relies on your Windows computer having the correct drivers setup (WinRT). I found this much flakier than the web version 
